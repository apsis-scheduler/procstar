...
// Before fork: Create pipe.
// In parent; Start collection task; takes Rc<Ref<...>>.
// In child: Close extraneous fds.
// At completion: Wait collection task.
...
impl MemoryCapture {
    fn new(fd: fd_t, format: spec::CaptureFormat) -> Result<Self> {
